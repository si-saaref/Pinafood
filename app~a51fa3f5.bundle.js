...
var RestaurantServices = function () {
  function getRestaurantList() {
    return _getRestaurantList.apply(this, arguments);
  }
  function _getRestaurantList() {
    _getRestaurantList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("".concat(_globals_config__WEBPACK_IMPORTED_MODULE_0__/* ["default"].BASE_URL */ .Z.BASE_URL, "/list"));
          case 3:
  ...
  function _getDetailRestaurant() {
    _getDetailRestaurant = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
      var response, responseJSON;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch("".concat(_globals_config__WEBPACK_IMPORTED_MODULE_0__/* ["default"].BASE_URL */ .Z.BASE_URL, "/detail/").concat(id));
          case 3:
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (RestaurantServices);
...
/* harmony import */ var _styles_css_starter_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(225);
/* harmony import */ var _styles_main_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46);
