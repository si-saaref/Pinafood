...
var routes = {
  ...
  '/restaurant/:id': _views_pages_detail__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z,
  '/favorites': _views_pages_favorite__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z
};
...
var DrawerInitiator = {
  init: function init(_ref) {
    ...
    button.addEventListener('click', function (event) {
      _this.__toggleDrawer(event, drawer);
    });
    mainContent.addEventListener('click', function (event) {
      _this.__closeDrawer(event, drawer);
    });
  ...
  __toggleDrawer: function __toggleDrawer(event, drawer) {
    event.stopPropagation();
    drawer.classList.toggle('active');
  },
  __closeDrawer: function __closeDrawer(event, drawer) {
    event.stopPropagation();
    drawer.classList.remove('active');
  },
  __handleAutoCloseDrawer: function __handleAutoCloseDrawer(drawer) {
...
var LayoutHelper = {
  ...
  handleColorHeader: function handleColorHeader() {
    var _this = this;
    document.addEventListener('scroll', function () {
      if (window.scrollY < 50) {
        _this.mainContent.classList.remove('reveal-content');
        _this.header.classList.remove('header-white');
      } else {
        _this.header.classList.add('header-white');
        _this.mainContent.classList.add('reveal-content');
      }
    });
  },
  showHeroImage: function showHeroImage() {
    this.heroImage.classList.add('show-hero');
  },
  hideHeroImage: function hideHeroImage() {
    this.heroImage.classList.remove('show-hero');
  },
  removeRevealContentSelector: function removeRevealContentSelector() {
    this.mainContent.classList.remove('reveal-content');
  },
  handleClickSkipButton: function handleClickSkipButton() {
...
var LikeButtonPresenter = {
  init: function init(_ref) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var likeButtonContainer, restaurant, FavoriteRestaurants;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            likeButtonContainer = _ref.likeButtonContainer, restaurant = _ref.restaurant, FavoriteRestaurants = _ref.favoriteRestaurants;
            _this.__likeButtonContainer = likeButtonContainer;
            _this.__restaurant = restaurant;
            _this.__favoriteRestaurants = FavoriteRestaurants;
            _context.next = 6;
            return _this.__renderButton();
          case 6:
          case "end":
  ...
  __renderButton: function __renderButton() {
    var _this2 = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            id = _this2.__restaurant.id;
            _context2.next = 3;
            return _this2.__isRestaurantExist(id);
          case 3:
            if (!_context2.sent) {
              _context2.next = 7;
              break;
            }
            _this2.__renderLiked();
            _context2.next = 8;
            break;
          case 7:
            _this2.__renderLike();
  ...
  __isRestaurantExist: function __isRestaurantExist(idRestaurant) {
    var _this3 = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _this3.__favoriteRestaurants.getRestaurant(idRestaurant);
          case 2:
  ...
  __renderLike: function __renderLike() {
    var _this4 = this;
    this.__likeButtonContainer.innerHTML = (0,_views_templates_template_creator__WEBPACK_IMPORTED_MODULE_0__/* .createLikeButtonTemplate */ .ty)();
    ...
    likeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _this4.__favoriteRestaurants.putRestaurant(_this4.__restaurant);
          case 2:
            _this4.__renderButton();
          case 3:
          case "end":
  ...
  __renderLiked: function __renderLiked() {
    var _this5 = this;
    this.__likeButtonContainer.innerHTML = (0,_views_templates_template_creator__WEBPACK_IMPORTED_MODULE_0__/* .createLikedButtonTemplate */ .ci)();
    var likeButton = document.querySelector('#likeButton');
    likeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return _this5.__favoriteRestaurants.deleteRestaurant(_this5.__restaurant.id);
          case 2:
            _this5.__renderButton();
          case 3:
          case "end":
